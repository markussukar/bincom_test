...
DROP TABLE IF EXISTS `bincom_test`.`agentname`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`agentname` (
...
INSERT INTO `bincom_test`.`agentname` (`name_id`, `firstname`, `lastname`, `email`, `phone`, `pollingunit_uniqueid`) VALUES
...
DROP TABLE IF EXISTS `bincom_test`.`announced_lga_results`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`announced_lga_results` (
...
INSERT INTO `bincom_test`.`announced_lga_results` (`result_id`, `lga_name`, `party_abbreviation`, `party_score`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
DROP TABLE IF EXISTS `bincom_test`.`announced_pu_results`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`announced_pu_results` (
  `result_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bincom_test`.`announced_pu_results` (`result_id`, `polling_unit_uniqueid`, `party_abbreviation`, `party_score`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
DROP TABLE IF EXISTS `bincom_test`.`announced_state_results`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`announced_state_results` (
  `result_id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bincom_test`.`announced_ward_results`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`announced_ward_results` (
  `result_id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bincom_test`.`lga`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`lga` (
...
INSERT INTO `bincom_test`.`lga` (`uniqueid`, `lga_id`, `lga_name`, `state_id`, `lga_description`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
DROP TABLE IF EXISTS `bincom_test`.`party`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`party` (
...
INSERT INTO `bincom_test`.`party` (`id`, `partyid`, `partyname`) VALUES
(1, 'PDP', 'PDP'),
(2, 'DPP', 'DPP'),
(3, 'ACN', 'ACN'),
(4, 'PPA', 'PPA'),
...
DROP TABLE IF EXISTS `bincom_test`.`polling_unit`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`polling_unit` (
  `uniqueid` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bincom_test`.`polling_unit` (`uniqueid`, `polling_unit_id`, `ward_id`, `lga_id`, `uniquewardid`, `polling_unit_number`, `polling_unit_name`, `polling_unit_description`, `lat`, `long`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
DROP TABLE IF EXISTS `bincom_test`.`states`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`states` (
...
INSERT INTO `bincom_test`.`states` (`state_id`, `state_name`) VALUES
(1, 'Abuja'),
(2, 'Abia'),
(3, 'Anambra'),
(4, 'Akwa Ibom'),
...
DROP TABLE IF EXISTS `bincom_test`.`ward`;
CREATE TABLE IF NOT EXISTS `bincom_test`.`ward` (
  `uniqueid` int(11) NOT NULL AUTO_INCREMENT,
  `ward_id` int(11) NOT NULL,
  `ward_name` varchar(50) NOT NULL,
  `lga_id` int(11) NOT NULL,
...
INSERT INTO `bincom_test`.`ward` (`uniqueid`, `ward_id`, `ward_name`, `lga_id`, `ward_description`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
